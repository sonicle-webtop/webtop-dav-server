...
use WT\Client\DAV\ApiException;
use WT\Client\DAV\Configuration;
use WT\Client\DAV\HeaderSelector;
...
class DavPrincipalsApi
{
     ...
     *
     * @throws \WT\Client\DAV\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \WT\Client\DAV\Model\PrincipalInfo
     */
     ...
     * @throws \WT\Client\DAV\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \WT\Client\DAV\Model\PrincipalInfo, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPrincipalInfoWithHttpInfo($profileUsername)
    {
        $returnType = '\WT\Client\DAV\Model\PrincipalInfo';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WT\Client\DAV\Model\PrincipalInfo',
